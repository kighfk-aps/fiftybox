...
has "$SKILL" "meta/muse-spark-1.2-contributor" "SKILL.md defaults CommandCode work to Muse Spark 1.2 Contributor"
lacks "$SKILL" "qwen/qwen3.7-flash" "SKILL.md no longer defaults CommandCode to qwen3.7-flash"
