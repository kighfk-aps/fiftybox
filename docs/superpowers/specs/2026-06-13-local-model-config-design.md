...
| 모델 | 컨테이너 | 엔드포인트 | 모델 ID |
|------|----------|------------|---------|
| 9B | `ollama-qwen35` (항상 실행 중) | `http://<퇴역-GPU서버>:11434/v1` | `qwen35-9b-262k-pi:latest` |
| 27B | `llama-qwen36-27b-iq4-128k` | `http://<퇴역-GPU서버>:8000/v1` | `serve-qwen36-27b-128k.sh`로 시작 |
| 35B A3B | `vllm-qwen-35b-gptq` | `http://<퇴역-GPU서버>:8000/v1` | `serve-vllm-current`로 시작 |
